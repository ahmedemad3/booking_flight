...
public class PessimisticLockService {
    ...
    public String bookTicket(Long flightId, String firstName, String lastName) {
        ...
        return "Ticket booked successfully with pessimistic lock";
    }
	...
	private Flight getFlight(Long flightId) {
		Flight flight = flightRepository.findWithPessimisticLockById(flightId).orElseThrow(() -> new RuntimeException("Flight not found"));
		return flight;
	}
}
